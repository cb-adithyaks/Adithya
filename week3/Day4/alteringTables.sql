...
Alter table marks alter column [quarterly] INTEGER NOT NULL;
Alter table marks alter column [half_yearly] INTEGER NOT NULL;
Alter table marks alter column [annual] INTEGER NOT NULL;
